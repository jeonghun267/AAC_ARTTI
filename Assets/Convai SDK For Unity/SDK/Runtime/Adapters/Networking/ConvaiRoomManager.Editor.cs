...
namespace Convai.Runtime.Adapters.Networking
{
    ...
    public partial class ConvaiRoomManager
    {
        ...
        private void OnValidate()
        {
            ...
            if (effectiveConnectionType != ConvaiConnectionType.Video)
            {
        ...
        private void QueueVisionSetupPrompt()
        {
            ...
            EditorApplication.delayCall += () =>
            {
                ...
                if (UnityEngine.Application.isPlaying || EffectiveConnectionType != ConvaiConnectionType.Video) return;
            ...
            if (!hasPublisher)
            {
                ...
                if (videoPublisherType == null)
                {
                    ConvaiLogger.Warning(
                        "[ConvaiRoomManager] ConvaiVisionPublisher type not found. Ensure Convai.Modules.Vision is installed.",
                        LogCategory.Vision);
                    success = false;
                }
        ...
        {
            ConvaiLogger.Warning(
                "[ConvaiRoomManager] Vision components are missing. Add ConvaiVisionPublisher and CameraVisionFrameSource (or another IVisionFrameSource) under this ConvaiRoomManager to enable vision streaming.",
                LogCategory.Vision);
        }
    }
}
