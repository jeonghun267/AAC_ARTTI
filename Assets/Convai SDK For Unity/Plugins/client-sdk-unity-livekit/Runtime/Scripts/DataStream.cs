...
namespace LiveKit
{
    ...
    public class StreamInfo
    {
        internal StreamInfo(
            ...
            long timestamp,
            ulong? totalLength,
            MapField<string, string> attributes,
            string mimeType)
        {
            Id = id;
            Topic = topic;
    ...
    public sealed class TextStreamReader
    {
        ...
        internal TextStreamReader(OwnedTextStreamReader info)
        {
            ...
            Info = new TextStreamInfo(info.Info);
        }
        ...
        {
            using FfiRequestWrap<TextStreamReaderReadAllRequest> request =
                FFIBridge.Instance.NewRequest<TextStreamReaderReadAllRequest>();
            TextStreamReaderReadAllRequest readAllReq = request.request;
        ...
        {
            using FfiRequestWrap<TextStreamReaderReadIncrementalRequest> request =
                FFIBridge.Instance.NewRequest<TextStreamReaderReadIncrementalRequest>();
            TextStreamReaderReadIncrementalRequest readIncReq = request.request;
            ...
            private void OnStreamEvent(TextStreamReaderEvent e)
            {
                ...
                switch (e.DetailCase)
                {
                    ...
                    case TextStreamReaderEvent.DetailOneofCase.Eos:
                        IsEos = true;
                        if (e.Eos.Error != null) Error = new StreamError(e.Eos.Error);
                        FfiClient.Instance.TextStreamReaderEventReceived -= OnStreamEvent;
                        break;
                }
            }
    ...
    public sealed class ByteStreamReader
    {
        ...
        {
            _handle = FfiHandle.FromOwnedHandle(info.Handle);
            Info = new ByteStreamInfo(info.Info);
        }
        ...
        public ReadAllInstruction ReadAll()
        {
            using FfiRequestWrap<ByteStreamReaderReadAllRequest> request =
                FFIBridge.Instance.NewRequest<ByteStreamReaderReadAllRequest>();
            ByteStreamReaderReadAllRequest readAllReq = request.request;
            readAllReq.ReaderHandle = (ulong)_handle.DangerousGetHandle();
        ...
        public ReadIncrementalInstruction ReadIncremental()
        {
            using FfiRequestWrap<ByteStreamReaderReadIncrementalRequest> request =
                FFIBridge.Instance.NewRequest<ByteStreamReaderReadIncrementalRequest>();
            ByteStreamReaderReadIncrementalRequest readIncReq = request.request;
            readIncReq.ReaderHandle = (ulong)_handle.DangerousGetHandle();
            request.Send();
        ...
        {
            using FfiRequestWrap<ByteStreamReaderWriteToFileRequest> request =
                FFIBridge.Instance.NewRequest<ByteStreamReaderWriteToFileRequest>();
            ByteStreamReaderWriteToFileRequest writeToFileReq = request.request;
    ...
    public class StreamOptions
    {
        ...
        public List<string> DestinationIdentities { get; set; } = new();
    ...
    public class StreamTextOptions : StreamOptions
    {
        ...
        public List<string> AttachedStreamIds { get; set; } = new();
        public bool? Generated { get; set; }

        internal Proto.StreamTextOptions ToProto()
        {
            var proto = new Proto.StreamTextOptions();
            if (Topic == null) throw new InvalidOperationException("Topic field is required");
            proto.Topic = Topic;
    ...
    public class TextStreamWriter
    {
        ...
        {
            using FfiRequestWrap<TextStreamWriterWriteRequest> request =
                FFIBridge.Instance.NewRequest<TextStreamWriterWriteRequest>();
            TextStreamWriterWriteRequest writeReq = request.request;
        ...
        {
            using FfiRequestWrap<TextStreamWriterCloseRequest> request =
                FFIBridge.Instance.NewRequest<TextStreamWriterCloseRequest>();
            TextStreamWriterCloseRequest closeReq = request.request;
    ...
    public class ByteStreamWriter
    {
        ...
        {
            using FfiRequestWrap<ByteStreamWriterWriteRequest> request =
                FFIBridge.Instance.NewRequest<ByteStreamWriterWriteRequest>();
            ByteStreamWriterWriteRequest writeReq = request.request;
            writeReq.WriterHandle = (ulong)_handle.DangerousGetHandle();
            writeReq.Bytes = ByteString.CopyFrom(bytes);
        ...
        public CloseInstruction Close(string reason = null)
        {
            using FfiRequestWrap<ByteStreamWriterCloseRequest> request =
                FFIBridge.Instance.NewRequest<ByteStreamWriterCloseRequest>();
            ByteStreamWriterCloseRequest closeReq = request.request;
            closeReq.WriterHandle = (ulong)_handle.DangerousGetHandle();
            closeReq.Reason = reason;
    ...
    internal sealed class StreamHandlerRegistry
    {
        ...
        {
            if (_textStreamHandlers.TryGetValue(reader.Info.Topic, out TextStreamHandler handler))
            {
        ...
        {
            if (_byteStreamHandlers.TryGetValue(reader.Info.Topic, out ByteStreamHandler handler))
            {
                handler(reader, participantIdentity);
                return true;
            }
